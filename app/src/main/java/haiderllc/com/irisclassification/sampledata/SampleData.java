...
public class SampleData {
    ...
    /*
    Return ArrayList of Iris Data
     */
    public static ArrayList<Iris> generateTrainingList() {
        ...
        for (int i = 0; i < 100; i++) {
            String[] numbers = IrisData[random.nextInt(IrisData.length)].split(comma);
    ...
    public static ArrayList<Iris> generateTestList() {

        ArrayList<Iris> irises = new ArrayList<Iris>();
        String comma = ",";

        int j = 0;
        for (int i = 100; i < IrisData.length; i++) {
            String[] numbers = IrisData[i].split(comma);
            // Grab values from that line and store it into a Iris ArrayList Item
            irises.add(j, new Iris(j, numbers[0], numbers[1], numbers[2], numbers[3], numbers[4]));
        }
        j++;
        return irises;
    }
